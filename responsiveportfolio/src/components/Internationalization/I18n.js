...
const translations_en = {
  ...
  GameEngine: "Game engine", AllEngines: "All engines",
  ProjectYear: "Year", AllYears: "All years", YearUnspecified: "Not specified",
  ProgrammingLanguage: "Programming language", AllProgrammingLanguages: "All languages",
...
const translations_fr = {
  ...
  GameEngine: "Moteur de jeu", AllEngines: "Tous les moteurs",
  ProjectYear: "Année", AllYears: "Toutes les années", YearUnspecified: "Non précisée",
  ProgrammingLanguage: "Langage de programmation", AllProgrammingLanguages: "Tous les langages",
  SearchHint: "Game, C#, Visual Studio, Jira, etc..",
